...
set(MSG_I_FLAGS "-Ilifter_ctr:/home/thesis/ROS/src/LimoDefault/lifter_ctr/msg;-Istd_msgs:/opt/ros/melodic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/thesis/ROS/src/LimoDefault/lifter_ctr/msg/lifter_mode.msg" NAME_WE)
add_custom_target(_lifter_ctr_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "lifter_ctr" "/home/thesis/ROS/src/LimoDefault/lifter_ctr/msg/lifter_mode.msg" ""
)
...
_generate_msg_cpp(lifter_ctr
  "/home/thesis/ROS/src/LimoDefault/lifter_ctr/msg/lifter_mode.msg"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/lifter_ctr)
  install(CODE "execute_process(COMMAND \"/usr/bin/python2\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/lifter_ctr\")")
  # install generated code
  install(
