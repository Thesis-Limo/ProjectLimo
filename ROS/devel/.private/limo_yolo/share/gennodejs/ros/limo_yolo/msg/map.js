...
class map {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    for (let i = 0; i < len; ++i) {
      data.obstacles[i] = geometry_msgs.msg.PointStamped.deserialize(buffer, bufferOffset)
    }
    ...
    for (let i = 0; i < len; ++i) {
      data.goal[i] = geometry_msgs.msg.PointStamped.deserialize(buffer, bufferOffset)
    }
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    if (msg.obstacles !== undefined) {
      ...
      for (let i = 0; i < resolved.obstacles.length; ++i) {
        resolved.obstacles[i] = geometry_msgs.msg.PointStamped.Resolve(msg.obstacles[i]);
      }
    }
    else {
      resolved.obstacles = []
    ...
    if (msg.goal !== undefined) {
      ...
      for (let i = 0; i < resolved.goal.length; ++i) {
        resolved.goal[i] = geometry_msgs.msg.PointStamped.Resolve(msg.goal[i]);
      }
    }
    else {
      resolved.goal = []
