...
if("TRUE" STREQUAL "TRUE")
  set(camera_info_manager_py_SOURCE_PREFIX /home/thesis/ROS/src/LimoDefault/src/camera_info_manager_py)
  set(camera_info_manager_py_DEVEL_PREFIX /home/thesis/ROS/devel/.private/camera_info_manager_py)
  ...
  set(camera_info_manager_py_INSTALL_PREFIX /home/thesis/ROS/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'camera_info_manager_py' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/thesis/ROS/src/LimoDefault/src/camera_info_manager_py/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT camera_info_manager_py_NUM_DUMMY_TARGETS)
      set(camera_info_manager_py_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::camera_info_manager_py::wrapped-linker-option${camera_info_manager_py_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR camera_info_manager_py_NUM_DUMMY_TARGETS "${camera_info_manager_py_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::camera_info_manager_py::wrapped-linker-option${camera_info_manager_py_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND camera_info_manager_py_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/thesis/ROS/devel/.private/camera_info_manager_py/lib;/home/thesis/ROS/devel/lib;/opt/ros/melodic/lib)
